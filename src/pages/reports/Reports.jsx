...
const navItems = [
  ...
  {
    label: "Consolidated Summarie",
    path: "consolidatedSummarie",
    icon: <FileText />,
  },
  ...
  { label: "Export and Sharing", path: "exportSharing", icon: <Share2 /> },
  {
    ...
    path: "comparativeInsights",
    icon: <LineChart />,
  },
  {
    label: "Visual Storytelling",
    path: "visualStorytelling",
    icon: <PieChart />,
  },
  {
    label: "Multi-Dimensional Breakdown",
    path: "multiDimensionalBreakdown",
    icon: <Layers />,
  },
  {
    label: "User Goals and Custom Insights",
    path: "GoalsCustomInsights",
    icon: <Target />,
  },
  ...
  return isLogged ? (
    <div className="container mx-auto min-h-screen px-4">
      ...
      <div className="flex flex-col lg:flex-row justify-center mt-6">
        {/* Sidebar */}
        <div className="w-full lg:w-1/4 lg:mr-20 border px-5 py-3 pb-20 border-1 mb-4 rounded-sm">
        ...
        {/* Main Content */}
        <div className="w-full lg:w-11/12 px-6 border py-3 border-1 rounded-sm mb-4">
          <h1 className="text-lg font-bold text-center my-3 border-b pb-4">
            {/* {getCurrentLabel()} */}
          </h1>
          <div className="flex flex-col">
            <Routes>
              ...
              <Route
                path="/comparativeInsights"
                element={<ComparativeInsights />}
              />
              <Route
                path="/visualStorytelling"
                element={<VisualStorytelling />}
              />
              <Route
                path="/multiDimensionalBreakdown"
                element={<MultiDimensionalBreakdown />}
              />
              <Route
                path="/GoalsCustomInsights"
                element={<GoalsCustomInsights />}
              />
