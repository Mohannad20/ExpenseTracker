      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
        ...
        <div className="flex flex-col border rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <Button className="border-muted bg-ring">
              <Link to="/transaction">Add Expense</Link>
            </Button>
            <Button variant="secondary" className="border border-foreground">
              <Link to="/transaction">Add Income</Link>
            </Button>
            ...
            <Button variant="" className="bg-chart-2 border border-foreground">
              <Link to="/reports/historicalAnalysis">View Reports</Link>
            </Button>
          </div>
        </div>
      </div>
